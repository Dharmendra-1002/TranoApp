...
const  MarketingExecutiveAddnewForm = () => {
...
<Text style={{ fontSize: 18, color: "black", marginTop: 5, marginLeft: 22 }}>Mode of Payment</Text>
...
<Text style={{ fontSize: 18, color: "black", marginTop: 5, marginLeft: 22 }}>Mode of Transport From Dispatch</Text>
...
export default  MarketingExecutiveAddnewForm
