...
const StateOrderForm = () => {
  ...
  const fullTableHead = [
    'S.No', '  Order Date  ', '        Executive Name  ', 'For State', 'Distributor/Dealer',' Business Name','Contact Person Name','Designation','Contact Number','Email-Id','Order for Device Type','Rate', 'Total Value', 'Extra Panic Buttons','Value of Panic Buttons', 'Grand Total Value(Rs.)','Payment Terms','Mode of Transport'
  ];
  ...
  const fullTableData = [
    ...
    ['02','             21-02-24', '                Rohit kumari', '       Telangana',  'TRANS001', 'J Tech.', 'Mr. Ashwin', ' Marketing Manager', '04590340', 'abc123@gmail.com', '','     10000','10000','','','','','Bus']
    // Additional rows...
  ];
    ...
    <SafeAreaView style={{ flex: 1, alignItems: 'center', backgroundColor: '#4e2d87' }}>
      <View style={{ backgroundColor: '#fff', width: '92%', height: '95%', borderRadius: 10, marginTop: 20 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('StateExpenseForm')}>
            <View>
