...
const AuthenticationAddNewForm = () => {
        ...
        <SafeAreaView className="flex-1 items-center justify-center" style={{ backgroundColor: '#4e2d87' }}>
            ...
            <View className="bg-white w-[90%] h-[95%] rounded-md mt-5">
                ...
                <View style={{ marginBottom: 20 }}>
                    <Text style={{ fontSize: 18, color: "black", marginTop: 5, marginLeft: 22 }}>Select Date</Text>
                    ...
                    <Text style={{ fontSize: 18, color: "black", marginTop: 5, marginLeft: 22 }}>Credit Limit</Text>
...
export default AuthenticationAddNewForm