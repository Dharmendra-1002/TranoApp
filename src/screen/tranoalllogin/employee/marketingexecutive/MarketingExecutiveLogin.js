          ...
          <View className={`w-[100%] h-[80%] bg-white rounded-lg shadow-lg px-5 py-5`}>
            <View className='space-y-3'>
              ...
              <View className='items-center justify-center'>
                <TouchableOpacity onPress={() => navigation.navigate('MarketingExecutiveHome')} className='bg-amber-500  rounded-lg py-2.5 w-[100%]'>
...
export default  MarketingExecutiveLogin;