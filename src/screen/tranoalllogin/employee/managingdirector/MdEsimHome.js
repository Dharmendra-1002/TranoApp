      ...
      <View className="bg-white w-[92%] h-[95%] rounded-md mt-5">
        ...
        <View className="flex-row justify-between py-12 px-6">
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('MdEsimHomeFrom')}
          >
          ...
          {/* Button for Devices */}
          <TouchableOpacity className="w-[43%] h-[89px] items-center bg-[#fff] shadow-md rounded-2xl"
            onPress={() => navigation.navigate('')}>
            <Text className="text-white font-medium text-lg py-1"></Text>
            <View className="w-full py-2 bg-[#fff] rounded-2xl mt-2 items-center">
              <Text className="text-white font-medium text-lg">57,476</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View className="items-center mt-8">
          <TouchableOpacity
            className="bg-[#fff] py-2 rounded-full items-center w-[85%] mb-[450px]"
            onPress={() => navigation.navigate('')}
          >
