        ...
        <SafeAreaView className="flex-1 items-center justify-center" style={{ backgroundColor: '#4e2d87' }}>
            ...
            <View className="bg-white w-[90%] h-[95%] rounded-md mt-5">
                ...
                <View style={{ marginBottom: 20 }}>
                    <Text style={{ fontSize: 18, marginTop: 5, marginLeft: 22 }}>Marketing Executive Name</Text>
                    ...
                    <Text style={{ fontSize: 18, marginTop: 5, marginLeft: 22 }}>State</Text>
                    ...
                    <Text style={{ fontSize: 18, marginTop: 5, marginLeft: 22 }}>Date of Expense</Text>
                    ...
                    <Text style={{ fontSize: 18, marginTop: 5, marginLeft: 22 }}>Expense head</Text>
                    ...
                    <Text style={{ fontSize: 18, marginTop: 5, marginLeft: 22 }}>Amount</Text>
...
export default StateExpenseForm