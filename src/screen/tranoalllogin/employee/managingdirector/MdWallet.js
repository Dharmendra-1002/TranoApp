    ...
    <SafeAreaView className=" flex-1 items-center" style={{ backgroundColor: '#4e2d87' }}>
      <View className=" bg-gray-100 w-[92%] h-[95%] rounded-md mt-5">
        <View className="items-center">
          <View className="bg-white  w-[80%] h-[58%] rounded-md mt-32" style={{elevation:100}}>
            {/* BUtton  1*/}
            <TouchableOpacity onPress={() => navigation.navigate('MdCreditLimit')}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('MdAllSelfValidity')}>
              <View className=" flex:1 items-center">
                <Text className=" text-white p-4  w-60  font-bold pt-5 mt-10 rounded-md text-center"style={{ backgroundColor: '#4e2d87' }}>
                Self Validity Recharges List
                </Text>
              </View>
            </TouchableOpacity>
